...
const getAllReviews = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield review_service_1.ReviewServices.getAllReviews(req.params.slug);
        res.status(200).json({
            success: true,
...
const getReviewById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const result = yield review_service_1.ReviewServices.getReviewBySlug(id);
        res.status(200).json({
            success: true,
            message: "Reviews are fetched successfully !",
            data: result,
...
const updateReview = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { slug } = req.params;
        const result = yield review_service_1.ReviewServices.updateReview(slug, req.body);
        res.status(200).json({
            success: true,
            message: "Reviews are fetched successfully !",
            data: result,
